...
do
        ...
        /usr/bin/python3 ${script_dir}/getMetrics_influxv2.py --sid $r --verbose --influxdb-host srvorap --influxdb-port 8087 --influxdb-org homelab --influxdb-token ${INFLUXDB_TOKEN} --influxdb-org oracle --influxdb-bucket homelab --sql-directory ${script_dir}/sql
