...
do
        ...
        /usr/bin/python3 ${script_dir}/getMetrics_influxv2.py --sid $r --verbose --influxdb-host srvorap --influxdb-port 8087 --influxdb-org homelab --influxdb-database influx --sql-directory ${script_dir}/sql
